...
print(f'm1 =  {m2} +- {m2_err}')
print(f'b1 = {b2} +- {b2_err}')
...
# sns.regplot(x=voltage[kink_index:], y=current[kink_index:])
print(voltage[kink_index:])
print(linear_fit(voltage[kink_index:], *popt_))
